...
<div class="h-screen w-screen">
  <form
    class="absolute left-1/2 top-1/2 flex max-w-md -translate-x-1/2 -translate-y-1/2 flex-col gap-6 rounded-box bg-base-200 p-6 text-center"
    method="POST"
    use:enhance={handleSubmit}
  >
    <h1 class="text-2xl font-bold">Login</h1>
    <p>Log in or Sign Up via magic link with your email below</p>
